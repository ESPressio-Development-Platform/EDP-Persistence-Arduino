...
The ConcreteProviders Arduino IDE target uses canonical `Arduino_IDE/Arduino_IDE.ino` primary-sketch naming so Arduino IDE / Arduino CLI can open the folder as a standards-compliant sketch.
